  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply blur-xl opacity-15 animate-pulse-slow" />
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply blur-xl opacity-15 animate-pulse-slow" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply blur-xl opacity-15 animate-pulse-slow" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <nav className="relative z-10 container mx-auto px-4 py-4 md:py-6 flex justify-between items-center max-w-6xl flex-wrap gap-3">
        ...
        <div className="flex gap-3 md:gap-6 items-center">
          ...
          <Link to="/football-analyzer" className="text-gray-300 hover:text-white transition-colors text-xs md:text-sm">NFL Analyzer</Link>
          <Link
            to="/plans"
      ...
      <section className="relative z-10 container mx-auto px-4 pt-8 md:pt-16 pb-8 md:pb-12 max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-purple-300/70 mb-4 uppercase tracking-widest">Built for faceless YouTube creators</p>
      ...
      <section className="relative z-10 container mx-auto px-4 pb-16 max-w-4xl">
        ...
        <div className="bg-gray-800/40 rounded-2xl p-6 border border-purple-500/20 text-center max-w-md mx-auto">
